...
---------
    ...
    3. easymore (version v2.0.0):
     ...
     (version used: https://github.com/ShervanGharari/EASYMORE@develop_2.0.0)
...
--------
     ...
     * spatial extents: ARB boundaries extracted from
    ...
    2. Landsat North American Land Change Monitoring System 2015 (NALCMS,
     v2, last accessed on October 18th, 2023, via gistool):

     * spatial extents: ARB boundaries extracted from
       MERIT-Basins dataset
     * temporal extents: annual landcover reported for 2015
     * landcover categories: 19 categories (for complete information,
     ...
     on October 18th, 2023, via gistool):

      * spatial extents: ARB boundaries extracted from
	MERIT-Basins dataset
      * temporal extents: soil map reported for 2017
